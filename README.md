...
<div id="header" align="center">
  ...
  ### Добро пожаловать. На данной странице я загружаю свои эксперементы в свободное от работы время. Тут большой уклон сделан на изучение инстурментов для написания кода и пробы новых(или уже не новых) технологий/инструментов.  
  
  Обо мне:
 👨‍💻 Попал в ИТ более 10 лет назад. Прошёл путь от "эникейщика" до системного администратора. А дальше... мне уже лень. 
